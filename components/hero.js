...
export default function Hero({ title, sub_title }) {
  return (
    <div className="relative bg-white">
        ...
        <div className="relative pb-8  sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          <main className="pt-10 mx-auto max-w-6xl px-4 sm:pt-12 sm:px-6 md:pt-16 lg:pt-20">
            <div className="text-left">
              <div className="max-w-[200px] lg:max-w-[500px]">
                <h1 className="text-natural-red z-50">{title}</h1>
              </div>
              {sub_title && (
                <div className="mt-3">
      ...
      <div className="md:absolute md:inset-y-0 md:right-0 md:w-1/3 lg:w-1/2 hidden md:block">
        <div className="hero">
          <Image
